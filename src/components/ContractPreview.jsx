...
const Field = ({ value, width = '100px', center = true, number }) => (
  <span className="relative inline-block align-bottom">
    ...
    <span 
      className={`inline-block border-b border-black px-1 mr-1 ${center ? 'text-center' : 'text-left'} whitespace-nowrap overflow-hidden align-bottom`} 
...
export const ContractPreview = React.forwardRef(({ data }, ref) => {
  return (
    <div ref={ref} className="font-sans text-black">
      {/* Page 1 */}
      <div className="bg-white px-[15mm] py-[10mm] w-[210mm] h-[297mm] mx-auto text-[12.5px] leading-[1.35] relative shadow-xl mb-4 print:mb-0 print:shadow-none print:w-[210mm] print:h-[297mm] print:break-after-page page-break-after overflow-hidden box-border">
        ...
        <div className="leading-[1.5] text-justify">
          <div className="flex flex-wrap items-baseline gap-2">
            ...
            <Field value={data.recipientAddress} width="100px" number="8" />
          </div>
          <div className="flex flex-wrap items-baseline gap-2 mt-1">
            ...
            <span>จังหวัด</span>
            <Field value={data.recipientProvince} width="100px" number="14" />
          </div>
          <div className="flex flex-wrap items-baseline gap-2 mt-1">
            <span>เบอร์โทร</span>
        ...
        {/* Body Paragraph 2 */}
        <div className="leading-[1.5] text-justify mt-1 indent-8">
          บริษัท จัสท์ คาร์ จำกัด เลขทะเบียนนิติบุคคล 0105561150013 <span className="inline-flex items-baseline gap-2 whitespace-nowrap">โดย<Field value={data.providerAuthPerson} width="200px" number="18" /></span> ผู้รับมอบ
          อำนาจ ซึ่งต่อไปในสัญญาฉบับนี้จะเรียกว่า “ผู้ให้บริการ” ฝ่ายหนึ่ง
        </div>

        <div className="font-bold mt-3 mb-2 text-center underline decoration-1 underline-offset-2">คู่สัญญาทั้งสองฝ่ายตกลงทำสัญญาฉบับนี้ โดยมีข้อตกลงและเงื่อนไขดังนี้</div>

        {/* Clause 1 */}
        <div className="mb-3">
          <div className="font-bold pl-8">ข้อ 1. คำนิยาม</div>
          <div className="pl-4 mt-1">
            <table className="w-full text-justify">
              <tbody>
                <tr className="align-top">
                  <td className="w-28 font-bold whitespace-nowrap pr-2 py-0.5">“ผู้รับบริการ”</td>
                  <td className="py-0.5">หมายถึง ผู้รับบริการ ที่ประสงค์จะขายรถยนต์ โดยที่ผู้ได้รับสิทธิ์มาจากบุคคลอื่น มาขายแทน หรือผู้ขายเป็นเจ้าของกรรมสิทธิ์เอง</td>
                </tr>
                <tr className="align-top">
                  <td className="font-bold whitespace-nowrap pr-2 py-0.5">“ผู้จะซื้อ”</td>
                  <td className="py-0.5">หมายถึง ผู้รับบริการ จัดหารถยนต์ ตามความต้องการ ซึ่งได้ใช้บริการผู้ให้บริการเป็นผู้จัดหาให้</td>
                </tr>
                <tr className="align-top">
        ...
        <div className="mb-2 text-justify">
          <span className="font-bold pl-8">ข้อ 2.</span> <span className="inline-block w-2"></span>ผู้รับบริการตกลงมีความประสงค์ที่จะขายรถยนต์ซึ่งตนเป็นเจ้าของกรรมสิทธิ์ และตกลงใช้บริการ ผู้ให้บริการ ในการ ชี้ช่องหรือจัดหาผู้จะซื้อรถยนต์ซึ่งมีรายละเอียดดังต่อไปนี้ <span className="inline-flex items-baseline gap-2 whitespace-nowrap">รถยนต์ประเภท<Field value={data.carType} width="100px" number="19" /></span> <span className="inline-flex items-baseline gap-2 whitespace-nowrap">ยี่ห้อ<Field value={data.carBrand} width="100px" number="20" /></span> <span className="inline-flex items-baseline gap-2 whitespace-nowrap">รุ่น<Field value={data.carModel} width="100px" number="21" /></span> <span className="inline-flex items-baseline gap-2 whitespace-nowrap">ปี<Field value={data.carYear} width="60px" number="22" /></span> <span className="inline-flex items-baseline gap-2 whitespace-nowrap">หมายเลขตัวรถ<Field value={data.carChassisNo} width="150px" number="23" /></span> <span className="inline-flex items-baseline gap-2 whitespace-nowrap">หมายเลขเครื่องยนต์<Field value={data.carEngineNo} width="150px" number="24" /></span> <span className="inline-flex items-baseline gap-2 whitespace-nowrap">หมายเลขทะเบียนรถ<Field value={data.carPlateNo} width="100px" number="25" /></span> รายละเอียดของรถปรากฏตามสมุดคู่มือทะเบียนรถแนบท้ายสัญญา และถือเป็นส่วนหนึ่งของสัญญานี้ ซึ่งต่อไปจะเรียกว่า "ทรัพย์สิน"
        </div>

        {/* Clause 3 */}
        <div className="mb-2 text-justify">
          <span className="font-bold pl-8">ข้อ 3.</span> <span className="inline-block w-2"></span>ผู้รับบริการตกลงจะขายทรัพย์สินดังกล่าว <span className="inline-flex items-baseline gap-2 whitespace-nowrap">เป็นเงินจำนวน<Field value={data.sellingPrice} width="120px" number="26" /></span> บาท <span className="inline-flex items-baseline gap-2 whitespace-nowrap">(<Field value={data.sellingPriceText} width="200px" number="27" />)</span> โดยผู้รับบริการตกลงให้ผู้ให้บริการรับเงินจาก ผู้ซื้อแทนผู้รับบริการ และผู้ให้บริการต้องส่งมอบเงินซึ่งได้จากการขายทรัพย์สินดังกล่าวให้กับผู้รับบริการ ด้วยวิธีการส่งมอบด้วยเงินสด หรือโอนเงินเข้าบัญชี<span className="inline-flex items-baseline gap-2 whitespace-nowrap">ธนาคาร<Field value={data.bankName} width="150px" number="28" /></span> <span className="inline-flex items-baseline gap-2 whitespace-nowrap">เลขที่บัญชี<Field value={data.bankAccountNo} width="150px" number="29" /></span> <span className="inline-flex items-baseline gap-2 whitespace-nowrap">ชื่อบัญชี<Field value={data.bankAccountName} width="200px" number="30" /></span> ซึ่งต่อไปในสัญญาฉบับนี้เรียกว่า “ราคาซื้อขาย”
        </div>

        {/* Clause 4 */}
        <div className="mb-1 text-justify">
          <span className="font-bold pl-8">ข้อ 4.</span> <span className="inline-block w-2"></span>ในกรณีที่ทรัพย์สินดังกล่าว มีการผ่อนชำระกับสถาบันการเงินหรือบุคคลอื่น มีการนำทรัพย์สินดังกล่าวไปเป็นหลักค้ำประกัน จำนำ หรือมีภาระผูกพันอื่นใดทางกฎหมาย ให้นำราคาซื้อขายตามข้อ 3 ชำระยอดหนี้ค้างชำระ เพื่อมีผลให้ทรัพย์สินปลอดภาระผูกพันทางกฎหมาย โดยมีรายละเอียดดังนี้
          <div className="pl-8 mt-0.5 space-y-1">
             <div>ราคาซื้อขายทรัพย์สิน<Field value={data.sellingPrice} width="150px" /> บาท (<Field value={data.sellingPriceText} width="200px" />)</div>
             <div>ยอดหนี้ค้างชำระ<Field value={data.debtAmount} width="150px" number="31" /> บาท (<Field value={data.debtAmountText} width="200px" number="32" />)</div>
             <div>ยอดคงเหลือส่วนต่าง<Field value={data.remainingBalance} width="150px" number="33" /> บาท (<Field value={data.remainingBalanceText} width="200px" number="34" />)</div>
          </div>
          <div className="mt-0.5 text-justify indent-8">
             โดยผู้ให้บริการอันเป็นการดำเนินการแทนในนามของผู้จะซื้อ ตกลงจะดำเนินการไปชำระปิดบัญชีให้แก่ผู้รับบริการ ภายใน<Field value={data.debtPayDate} width="50px" number="35" /> วัน โดยมีค่าบริการจำนวน<Field value={data.serviceFee} width="100px" number="36" /> บาท (<Field value={data.serviceFeeText} width="150px" number="37" />) เพื่อให้ทรัพย์สินปลอดภาระผูกพันทางกฎหมาย
          </div>
        </div>
      ...
      {/* Page 2 */}
      <div className="bg-white px-[15mm] py-[10mm] w-[210mm] h-[297mm] mx-auto text-[12.5px] leading-[1.35] relative shadow-xl mb-4 print:mb-0 print:shadow-none print:w-[210mm] print:h-[297mm] print:break-after-page overflow-hidden box-border">
        <Header />
        {/* Clause 5 */}
        <div className="mb-2 text-justify">
          <span className="font-bold pl-8">ข้อ 5.</span> <span className="inline-block w-2"></span>ในกรณีที่ผู้รับบริการไม่สามารถส่งมอบทรัพย์สินให้กับผู้ให้บริการ หรือผู้จะซื้อได้ทันทีนับแต่วันทำสัญญาฉบับนี้ แต่ผู้รับบริการได้รับเงินมัดจำจากผู้จะซื้อเพื่อเป็นพยานหลักฐานว่าสัญญาซื้อขายได้เกิดขึ้นและมีผลบังคับใช้ตามกฎหมายแล้ว และเป็นหลักประกันที่จะปฏิบัติตามสัญญาซื้อขายนั้น โดยผู้ให้บริการได้ส่งมอบเงินมัดจำให้ผู้รับบริการด้วยวิธีการโอนเงินเข้าบัญชีธนาคารในข้อที่ 3 เป็นเงินจำนวน<Field value={data.depositAmount} width="100px" number="38" /> บาท (<Field value={data.depositAmountText} width="150px" number="39" />) ผู้รับบริการให้คำมั่นว่าจะส่งมอบทรัพย์สินและเอกสารอื่นๆที่เกี่ยวกับทรัพย์สิน <span className="text-[#0047BA] underline">เพื่อการจดทะเบียนโอนกรรมสิทธิ์</span> ให้แก่ผู้ให้บริการเพื่อส่งมอบให้ผู้จะซื้อ ภายในวันที่<Field value={data.documentDeliveryDate} width="100px" number="40" />
          ...
          <div className="text-justify mt-1 text-[#0047BA] indent-8">
              ผู้ให้บริการ ขอสงวนสิทธิ์ในการ หักเงินประกันการทำสัญญาไว้ จำนวน<Field value={data.warrantyDeduction} width="100px" number="41" /> บาท ในกรณีที่ผู้รับบริการไม่สามารถส่งมอบเอกสารที่ใช้เพื่อการจดทะเบียนให้ครบถ้วนได้ในวันทำสัญญา โดยผู้ให้บริการจะเก็บเงินรักษาเงินประกันการทำสัญญาดังกล่าวไว้จนกว่าผู้รับบริการจะส่งมอบเอกสารที่ใช้เพื่อการจดทะเบียนให้ครบถ้วน
          </div>
        </div>

        {/* Clause 6 */}
        <div className="mb-2 text-justify">
           <span className="font-bold pl-8">ข้อ 6.</span> <span className="inline-block w-2"></span>ในกรณีที่ผู้รับบริการได้ส่งมอบทรัพย์สินให้กับผู้จะซื้อ และผู้จะซื้อได้รับมอบทรัพย์สินจากผู้รับบริการในสภาพเรียบร้อยตรงตามวัตถุประสงค์ของผู้จะซื้อ และผู้จะซื้อได้ชำระราคาทรัพย์สินให้กับผู้รับบริการแล้ว ให้ถือว่ากรรมสิทธิ์ในทรัพย์สินได้โอนไปยังผู้จะซื้อเรียบร้อยแล้วนับแต่วันที่ได้ตกลงทำสัญญานี้ และให้ถือว่าผู้ให้บริการเป็นผู้ชี้ช่องหรือจัดหาเป็นธุระให้ผู้รับบริการได้เข้าทำสัญญาซื้อขายทรัพย์สินกับผู้จะซื้อแล้ว โดยให้ถือว่าสัญญาซื้อขายทรัพย์สินดังกล่าวเป็นผลงานของผู้ให้บริการ และมีผลบังคับใช้ได้ตามกฎหมาย
        </div>

        {/* Clause 7 */}
        <div className="mb-2 text-justify">
           <span className="font-bold pl-8">ข้อ 7.</span> <span className="inline-block w-2"></span>ผู้รับบริการตกลงว่า จะชำระค่าบำเหน็จเพื่อเป็นการตอบแทนให้แก่ผู้ให้บริการ ในกรณีที่ผู้ให้บริการได้ทำการชี้ช่องหรือจัดหาผู้จะซื้อทรัพย์สินดังกล่าวให้กับผู้รับบริการ และต้องชำระค่าบำเหน็จแก่ผู้ให้บริการในกรณีที่ขายได้ดังนี้
        ...
        {/* Clause 8 */}
        <div className="mb-2 text-justify">
           <span className="font-bold pl-8">ข้อ 8.</span> <span className="inline-block w-2"></span>ผู้รับบริการตกลงว่า จะเป็นผู้รับผิดชอบทั้งหมดต่อค่าใช้จ่ายที่เกิดขึ้น ก่อนวันที่ได้ตกลงทำสัญญาฉบับนี้ เช่น ค่าภาษี ค่าอากร ค่าปรับ ค่าธรรมเนียม ค่าใช้จ่ายอื่นใดซึ่งกฎหมายบังคับให้ต้องชำระ เป็นต้น
        </div>

        {/* Clause 9 */}
        <div className="mb-2 text-justify">
           <span className="font-bold pl-8">ข้อ 9.</span> <span className="inline-block w-2"></span>หากทรัพย์สินดังกล่าวโอนกรรมสิทธิ์ไม่ได้ ผู้รับบริการต้องคืนเงินแก่ผู้จะซื้อเต็มจำนวนทันที หากพ้นกำหนดระยะเวลาในการคืนเงินแล้วผู้รับบริการไม่สามารถคืนเงิน ให้แก่ผู้ให้บริการได้ผู้รับบริการตกลงชำระดอกเบี้ยผิดนัดในอัตราร้อยละ 15 ต่อปี
        </div>
        
        {/* Clause 10 */}
        <div className="mb-2 text-justify">
           <span className="font-bold pl-8">ข้อ 10.</span> <span className="inline-block w-2"></span>หากทรัพย์สินดังกล่าวไม่สามารถดำเนินการจดทะเบียนเพื่อเปลี่ยนแปลงกรรมสิทธิ์ต่อกรมขนส่งทางบกได้ หรือ ในกรณีที่ผู้ให้บริการได้ดำเนินการตรวจสอบเพิ่มเติมภายหลัง แล้วปรากฏว่ามีกรณีใดกรณีหนึ่งดังต่อไปนี้
      ...
      {/* Page 3 */}
      <div className="bg-white px-[15mm] py-[12mm] w-[210mm] h-[297mm] mx-auto text-[12.5px] leading-[1.35] relative shadow-xl print:shadow-none print:w-[210mm] print:h-[297mm] overflow-hidden box-border">
        <Header />
        
        {/* Clause 12 */}
        <div className="mb-3 text-justify">
           <span className="font-bold pl-8">ข้อ 12.</span> <span className="inline-block w-2"></span>ผู้รับบริการยินยอมให้ตัวแทนผู้รับบริการ ดำเนินการจัดเก็บ รวบรวม เก็บรักษา ใช้ หรือเปิดเผยข้อมูลส่วนบุคคล เพื่อใช้ประโยชน์ในการดำเนินกิจการของตัวแทนผู้รับบริการ และให้ปฏิบัติตามพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล โดยตัวแทนผู้รับบริการจะเก็บรักษาข้อมูลดังกล่าว ไว้เป็นความลับ
        </div>

        {/* Clause 13 */}
        <div className="mb-3 text-justify">
           <span className="font-bold pl-8">ข้อ 13.</span> <span className="inline-block w-2"></span>ผู้รับบริการตกลงใช้ข้อมูลที่อยู่ดังต่อไปนี้ ในการประสานงานติดต่อ หรือจัดส่งเอกสารใด ๆ และการบอกกล่าว ทวงถาม หรือส่งเอกสารใด ๆ อันพึงมีไปยังคู่สัญญาอีกฝ่ายหนึ่ง ตามภูมิลำเนาที่ปรากฏในสัญญานี้ ให้ถือว่า เป็นการส่งโดยชอบ และคู่สัญญาอีกฝ่ายได้ทราบแล้วใน วันที่คำบอกกล่าว หรือเอกสารนั้น ๆ พึงไปถึงตามปกติ
        ...
        {/* Clause 14 */}
        <div className="mb-3 text-justify">
           <div className="font-bold mb-1 pl-8">ข้อ 14. ข้อตกลงอื่น ดังนี้</div>
        ...
        <div className="mb-4 text-justify">
           <div className="font-bold mb-1 pl-8">ข้อ 15. การขายพร้อมทรัพย์สินอื่น และ ประกันภัย</div>
           <div className="indent-8">
